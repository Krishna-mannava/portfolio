...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="italic">Hello,</span> I'm <span className="font-bold">Geetha Krishna</span>, a {" "}
        <span className="font-bold"> Software Developer</span> on a mission to blend 
        technology with passion. Boasting {" "}
        <span className="font-bold">2.5 years</span> of experience in {" "}
      ...
      >
        ...
        <a
          ...
          href="./Geetha_Krishna_Mannava_Resume_HackerRank.pdf"
          download
        >
          Download CV{" "}
        ...
        <a
          ...
          href="https://www.linkedin.com/in/krishnamannava/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/Krishna-mannava"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://leetcode.com/u/nomorekratos/"
          target="_blank"
        >
          <FaCode />
        </a>
